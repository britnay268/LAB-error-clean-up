...
const expelledStudentsOnDom = (array) => {
  ...
  array.forEach((item) => {
    ...
    <div class="voldemort-card" style="width: 15rem;">
      ...
      <div class="card-body">
        <p class="card-text" style="font-weight:bold; margin-top:10px; margin-bottom:5px; color:white; text-align:center;">Welcome to the dark side <span id="expelled-student">${item.name}</span></p>
      </div>
    </div>`;
  });
